 /* Latest code with iOS bluetooth support and direct string transfer from ionic 
...
int initialServoR = 30; // Right arm starts at rightmost position. This is the max it goes out



int ServoR_max = 5; //ServoR_max mean how close to the center the right servo arm gets. 
                    //5 means perpendicular this should not go below 5. 
                    //Increase this for lighter breaths

int initialServoL = 0; //Left arm starts at leftmost position. This is the max it goes out
int ServoL_max = 25; //ServoL_max mean how close to the center the left servo arm gets.
...
void setup() {
  Serial.begin(9600);
  Serial.println("<Arduino is ready for ya!>");
  myservoR.attach(9);
